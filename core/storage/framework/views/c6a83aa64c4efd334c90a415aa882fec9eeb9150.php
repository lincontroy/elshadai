...
?>
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h1 class="page-title">Welcome Mentor <?php echo e($user->usr); ?></h1>
								<ol class="breadcrumb">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
										 <a href="https://futuregain.xyz/register/<?php echo e($user->username); ?>" onclick="copyURI(event)" class="btn btn-info" id="reflnk" >
                                                <!--<small><?php echo e(env('APP_URL').__('/register/').$user->username); ?></small>-->
                                                Copy Link
                                            </a>  
						...
						<div class="row">
                            ...
                            <div class="collapse" id="collapseExample">
                              <div class="card card-body">
                                  <a href="https://chat.whatsapp.com/Fat6bZbpvuDGGjwwYV7Jzt">Group1</a><br>
                                  <a href="https://chat.whatsapp.com/IeCk5v8yeJM929srR8BsLC">Group2</a><br>
                                  <a href="https://chat.whatsapp.com/DUYwsG4UP9GEijOfQvoK0S">Group3</a><br>
                               </div>
                            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/futuregain.xyz/core/resources/views/user/index.blade.php ENDPATH**/ ?>