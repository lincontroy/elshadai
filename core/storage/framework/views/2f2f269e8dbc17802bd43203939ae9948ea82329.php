...
?>
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h1 class="page-title text-info text-center">User No: <?php echo e($user->id); ?>'s Dashboard</h1>
								<ol class="breadcrumb">
       ...
       <!--                                                 </div>-->
            ...
            <?php if(isset($invs) && count($invs) > 0): ?>
                    ...
                    <div class=" p-5 collapse align-center" id="collapseExample">
					
							<div class="col-sm-6 col-lg-6 col-xl-3" id=>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
										 <a href="https://app.goldentec.xyz/register/<?php echo e($user->username); ?>" onclick="copyURI(event)" class="btn btn-dark" id="reflnk" >
                                                <!--<small><?php echo e(env('APP_URL').__('/register/').$user->username); ?></small>-->
                                                Copy Link
                                            </a>  
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/app.goldentec.xyz/core/resources/views/user/index.blade.php ENDPATH**/ ?>