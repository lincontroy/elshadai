<?php $__env->startSection('content'); ?>
						...
						<div class="row">
                            ...
                            <div class="collapse" id="collapseExample">
                              <div class="card card-body">
                                  <!--<a href="<?php echo e(env('ENOCK_GROUP')); ?>">Group1</a><br>-->
          ...
          <form id="wd_formssss" action="/user/wdraw/earning" method="post">
              ...
              <div class="form-group">
                <br><br>
                  <button type="submit" class="btn btn-info"> <?php echo e(__('Withdraw')); ?> </button>
                  <span style="">            
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/nakamotoagencies.xyz/core/resources/views/user/my_investment.blade.php ENDPATH**/ ?>