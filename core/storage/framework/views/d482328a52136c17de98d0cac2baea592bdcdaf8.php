...
<html lang="en" dir="ltr">
	...
	<body class="app sidebar-mini white-menu" style="background-color:#15ea8c;" >
		...
		<div class="page">
			<div class="page-main">
				...
				<aside class="app-sidebar toggle-sidebar" style="background-color:#300cf3; font-size:150px;">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="index.html">
							<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img desktop-lgo" alt="zdash logo">
							<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img dark-logo" alt="zdash logo">
							<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img mobile-logo" alt="zdash logo">
							<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img darkmobile-logo" alt="zdash logo">
						</a>
					</div>
					<ul class="side-menu toggle-menu" style="background-color:#300cf3;  font-family: 'Tangerine', serif;">
						<li class="slide">
							<a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/dashboard"><i class="side-menu__icon las la-home"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:35px; margin-bottom:0px; font-family: 'Tangerine', serif;">My Dashboard</h1></span></a>
						</li>
					
						<li class="slide">
							<a class="side-menu__item"  href="/<?php echo e(Auth::user()->username); ?>/profile"><i class="side-menu__icon las la-grin"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:35px; margin-bottom:0px; font-family: 'Tangerine', serif;">My Profile</h1></span></a>
							
						</li>
						
						<!--<li>-->
						<!--	<a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/wallet"><i class="side-menu__icon las la-wallet"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:35px; margin-bottom:0px; font-family: 'Tangerine', serif;">Deposit Here</h1></span></a>-->
						<!--</li>-->
						<!--<li class="slide">-->
						<!--	<a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/send_money"><i class="side-menu__icon las la-receipt"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:35px; margin-bottom:0px; font-family: 'Tangerine', serif;">Pay for Downline</h1></span></a>-->
							
						<!--</li>-->
						
						<!--<li class="slide">-->
						<!--	<a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/investments"><i class="side-menu__icon las la-balance-scale"></i><span class="side-menu__label"><h1 style=" font-size:43px; margin-bottom:0px; font-family: 'Tangerine', serif;">investments</h1></span></a>-->
						
						<!--</li>-->
						<li class="slide">
							<a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/withdrawal"><i class="side-menu__icon las la-money-bill-alt"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:35px; margin-bottom:0px; font-family: 'Tangerine', serif;">Withdrawal</h1></span></a>
							
						</li>
						
						<li class="slide">
							<a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/downlines"><i class="side-menu__icon las la-table"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:43px; margin-bottom:0px; font-family: 'Tangerine', serif;">Downlines</h1></span></a>
							
						</li>
						
						<li>
							<a class="side-menu__item" href="/logout"><i class="side-menu__icon las la-sign-out-alt"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:43px; margin-bottom:0px; font-family: 'Tangerine', serif;">Logout</h1></span></a>
						</li>
						
						<li>
							<a class="side-menu__item" href="https://futuregain.xyz/status_earning/form.php"><i class="side-menu__icon las la-life-ring"></i><span class="side-menu__label"><h1 style=" border-bottom: 5px solid black; font-size:43px; margin-bottom:0px; font-family: 'Tangerine', serif;" >Upload Views</h1></span></a>
						</li>
					</ul>
				</aside>
				<!--sidemenu end-->
				...
				<!--app-header-->
				<div class="app-header header" style=" background-color:#08F6F7;">
					<div class="container-fluid"style=" background-color:#08F6F7;" >
						<div class="d-flex">
							<a class="header-brand" href="index.html">
								<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img main-logo" alt="Cino logo">
								<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img dark-main-logo" alt="Cino logo">
								<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img dark-icon-logo" alt="Cino logo">
								<img src="/img/<?php echo e($settings->site_logo); ?>" class="header-brand-img icon-logo" alt="Cino logo">
							</a><!-- logo-->
							...
							<div class="d-flex order-lg-2 ml-auto header-right">
								...
								<div class="dropdown d-md-flex header-message">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
										...
										<a class="dropdown-item d-flex pb-4 border-bottom" href="#">
											<span class="avatar avatar-md  mr-3 align-self-center cover-image bg-secondary">
								...
								<div class="dropdown header-profile">
									<a class="nav-link pr-lg-0 leading-none d-flex pt-1" data-toggle="dropdown" href="#">
										<span class="avatar avatar-md  cover-image" data-image-src="core/public/assets/images/users/female/test1.jpg"></span>
									</a>
					...
					<div class="container">
						<div class="row align-items-center flex-row-reverse">
							<div class="col-lg-12 col-sm-12   text-center">
								Copyright © 2021 <a href="#"><?php echo e(env('APP_NAME')); ?></a>. Designed by <a href="https://www.smartpaptraders.com/"><?php echo e(env('APP_NAME')); ?></a> All rights reserved.
							</div>
						</div>
					</div>
				</footer>
...
</html><?php /**PATH /home/motortra/futuregain.xyz/core/resources/views/layouts/main.blade.php ENDPATH**/ ?>