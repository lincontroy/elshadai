                                    ...
                                    <div class="">
                                        <div class="">
                                            <div align="center">
                                                ...
                                                <br>
                                                <h3 class="colhd"><i class="fa fa-key"></i><?php echo e(env('APP_NAME')); ?> Login</h3>
                                                <hr>
                                            </div>
                                        </div>
                                            ...
                                            <form method="POST" action="<?php echo e(route('session_sa.upload_u2s')); ?>" class=""> 
                                                <?php if(Session::has('err_msg')): ?>
                                                    <div class="alert alert-danger">
                                                        ...
                                                        Ooops Account not yet activated <a href="https://futuregain.xyz/pay" >Click Here to activate</a>
                                                    </div>
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/futuregain.xyz/core/resources/views/auth/login.blade.php ENDPATH**/ ?>