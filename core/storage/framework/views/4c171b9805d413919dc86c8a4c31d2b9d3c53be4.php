...
?>
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h1 class="page-title text-white text-center">WELCOME BACK <?php echo e($user->firstname); ?></h1>
								<ol class="breadcrumb">
										...
										<div class="d-flex">
											...
											<div class="text-white mt-3">
												<p class="mb-1 font-weight-semibold fs-14 text-success"> REFERRAL BONUS </p>
																								...
																								?>
												<h2 class="mt-1 mb-0 fs-30 font-weight-bold "><?php echo "$symb" ?> <?php echo e($new_ref); ?></h2>
											</div
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
										 <a href="https://nakamotoagencies.xyz/register/<?php echo e($user->username); ?>" onclick="copyURI(event)" class="btn btn-dark" id="reflnk" >
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/nakamotoagencies.xyz/core/resources/views/user/index.blade.php ENDPATH**/ ?>