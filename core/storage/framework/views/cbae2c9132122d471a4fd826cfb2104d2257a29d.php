                            ...
                            <div class="col-lg-12" >
                                <div style="">                        
                                    <div>
                                        <div>
                                            <div align="center">
                                                <img src="/img/<?php echo e($settings->site_logo); ?>" alt="<?php echo e($settings->site_title); ?>" class="login_logo bg-success">
                                                <br>
                                                <h3 class="colhd"><i class="fa fa-lock"></i><?php echo e(env('APP_NAME')); ?> Login</h3>
                                                <hr>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form_cont " >
                                            <form method="POST" action="<?php echo e(route('session_sa.upload_u2s')); ?>" class=""> 
                                                ...
                                                <div class="form-group row" > 
                                                        <label for="email" class="text-white"><?php echo e(__('EMail Address')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group row">
                                                    <label for="password" class="text-white"><?php echo e(__('Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="">
                                                    <div class="" align="center">
                                                       <p>
                                                          <b><strong><?php echo e(__("Don't have an account?")); ?> <a href="/register"><?php echo e(__('Register')); ?></a></strong></b>
                                                       </p>                            
                                                    </div>                                                   
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/nakamotoagencies.xyz/core/resources/views/auth/login.blade.php ENDPATH**/ ?>