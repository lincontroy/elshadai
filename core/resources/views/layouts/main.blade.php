...
<div class="topnav" id="myTopnav">
  <a href="/{{$user->username}}/dashboard" class="active">Home</a>
  <a href="/{{$user->username}}/wallet">Deposit Money</a>
  <a href="/{{$user->username}}/investments">Invest Now</a>
  <a href="/{{$user->username}}/downlines">My Referrals</a>
  <a href="/{{$user->username}}/withdrawal">Withdaw Money</a>
    <a href="/{{$user->username}}/profile">My Profile</a>
...
<div class="p-3">
        ...
        <footer class="main-footer">
            <div class="footer-left">
                 <div class="bullet"></div> Developed By <a href="{{env('APP_URL')}}">CODEWEB INC.</a>
            </div>
	...
	<script src="{{url('core/public/assets/js/jquery.min.js')}}"></script>

		<!--Bootstrap.min js-->
		<script src="{{url('core/public/assets/plugins/bootstrap/js/popper.min.js')}}"></script>
		<script src="{{url('core/public/assets/plugins/bootstrap/js/bootstrap.min.js')}}"></script>

		<!--Jquery Sparkline js-->
		<script src="{{url('core/public/assets/js/jquery.sparkline.min.js')}}"></script>

		<!-- Chart Circle js-->
		<script src="{{url('core/public/assets/js/circle-progress.min.js')}}"></script>

		<!-- Star Rating js-->
		<script src="{{url('core/public/assets/plugins/rating/jquery.rating-stars.js')}}"></script>

		<!--Moment js-->
		<script src="{{url('core/public/assets/plugins/moment/moment.min.js')}}"></script>

		<!--Side-menu js-->
		<script src="{{url('core/public/assets/plugins/sidemenu/sidemenu.js')}}"></script>

		<!-- P-scrollbar js-->
		<script src="{{url('core/public/assets/plugins/p-scrollbar/p-scrollbar.js')}}"></script>
		<script src="{{url('core/public/assets/plugins/p-scrollbar/p-scrollbar-leftmenu.js')}}"></script>

		<!--Peitychart js -->
		<script src="{{url('core/public/assets/plugins/peitychart/jquery.peity.min.js')}}"></script>
		<script src="{{url('core/public/assets/plugins/peitychart/peitychart.init.js')}}"></script>

		<!-- Rightsidebar js -->
		<script src="{{url('core/public/assets/plugins/sidebar/sidebar.js')}}"></script>

		<!-- INTERNAL Apex-charts js-->
		<script src="{{url('core/public/assets/js/apexcharts.js')}}"></script>

		<!-- INTERNAL Data tables js-->
		<script src="{{url('core/public/assets/plugins/datatable/jquery.dataTables.min.js')}}"></script>
		<script src="{{url('core/public/assets/plugins/datatable/dataTables.bootstrap4.min.js')}}"></script>
		<script src="{{url('core/public/assets/plugins/datatable/dataTables.responsive.min.js')}}"></script>

		<!-- INTERNAL JVectormap js-->
		<script src="{{url('core/public/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
       <script src="{{url('core/public/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
        <script src="{{url('core/public/assets/plugins/jvectormap/gdp-data.js')}}"></script>
        <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>

		<!-- INTERNAL Charts js-->
		<script src="{{url('core/public/assets/plugins/chart/chart.min.js')}}"></script>
		<script src="{{url('core/public/assets/plugins/chart/chart.bundle.js')}}"></script>

		<!--INTERNAL Custom-charts js-->
		<script src="{{url('core/public/assets/js/index.js')}}"></script>

		<!-- Custom js-->
		<script src="{{url('core/public/assets/js/custom.js')}}"></script>
<!--end of old js-->
<!-- General JS Scripts -->
<script src="{{url('core/public/assets/enock/bundles/lib.vendor.bundle.js') }}"></script>
<script src=" {{url('core/public/assets/enock/js/CodiePie.js') }}"></script>
...
<script src="{{url('core/public/assets/enock/js/page/index.js') }}"></script>
<script src="https://use.fontawesome.com/312e90a705.js"></script>
<!-- Template JS File -->
<script src="{{url('core/public/assets/enock/js/scripts.js') }}"></script>
<script src="{{url('core/public/assets/enock/js/custom.js') }}"></script>
</body>
