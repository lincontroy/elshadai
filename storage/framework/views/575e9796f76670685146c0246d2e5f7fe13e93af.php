...
-
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h1 class="page-title">Welcome Investor <?php echo e($user->usr); ?></h1>
								<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col-lg-3 col-md-6">
								<div class="card bg-dark img-card overflow-hidden">
								    <div class="panel panel-default">
                                                  <div class="panel-heading">This carries your account balance</div>
                                                  <div class="panel-body">Actually Total Referrals Income remaining</div>
                                                </div>
									<div class="card-body">
										<div class="d-flex">
											<div class="mr-5">
											...
											<div class="text-white mt-3">
												<p class="mb-1 font-weight-semibold fs-14">ACCOUNT BALANCE </p>
       ...
       <!--             								    <div class="panel panel-default">-->
       <!--             								        <div class="panel-heading">This carries your total  status earnings</div>-->
       <!--                                                   <div class="panel-body">Total views income</div>-->
       <!--                                                 </div>-->
							<!--		<div class="card-body">-->
							<!--			<div class="d-flex">-->
							<!--				<div class="mr-5">-->
							...
							<!--				</div>-->
							<!--				<div class="text-white mt-3">-->
							<!--					<p class="mb-1 font-weight-semibold fs-14">VIEWS EARNINGS </p>-->
							<!--					<h2 class="mt-1 mb-0 fs-30 font-weight-bold "><?php echo "$symb";?> <?php echo "$new_views"; ?></h2>-->
							<!--				</div>-->
							<!--			</div>-->
							<!--		</div>-->
							<!--		<img src="<?php echo e(url('core/public/assets/images/png/circle.png')); ?>" alt="img" class="img-card-circle">-->
							...
							<div class="col-lg-3 col-md-6">
								<div class="card bg-gradient-danger img-card overflow-hidden">
								    <div class="panel panel-default">
      <div class="panel-heading">This contain total referral income</div>
      <div class="panel-body">Referral income</div>
    </div>
									<div class="card-body">
										<div class="d-flex">
											<div class="mr-5">
							...
							<div class="col-lg-3 col-md-6">
								<div class="card bg-success img-card overflow-hidden">
								    <div class="panel panel-default">
      <div class="panel-heading">This contains your total cashout</div>
      <div class="panel-body">Total withdrawals</div>
    </div>
									<div class="card-body">
										<div class="d-flex">
											<div class="mr-5">
							...
							<div class="col-sm-6 col-lg-6 col-xl-3">
								<div class="card card-pricing shadow text-center px-3 ">
									...
									<div class="card-body pt-0">
										...
										<a id="<?php echo e($inv->id); ?>" href="javascript:void(0)"  class="btn btn-info mb-3" onclick="confirm_inv('<?php echo e($inv->id); ?>', '<?php echo e($inv->package_name); ?>', '<?php echo e($inv->period); ?>', '<?php echo e($inv->daily_interest); ?>', '<?php echo e($inv->min); ?>', '<?php echo e($inv->max); ?>', '<?php echo e($user->wallet); ?>')">Order Now</a>
									</div>
								</div>
							</div><!-- col-end -->
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
										 <a href="https://appletraders.co.ke/register/<?php echo e($user->username); ?>" onclick="copyURI(event)" class="btn btn-dark" id="reflnk" >
                                                <!--<small><?php echo e(env('APP_URL').__('/register/').$user->username); ?></small>-->
                                                Copy Link
                                            </a>  
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/appletraders.co.ke/core/resources/views/user/index.blade.php ENDPATH**/ ?>