            ...
            ?>
             ...
             <div class="row">
										...
										<div class="row">
											...
											<div class="col-8 text-center">
												<div class="mt-4 mb-0 text-success">
													...
													<h2 class="btn btn-link mb-0"> MPESA NUMBER : </h2>+254745687936<br>
                      ...
                      <div class="row">
                        <div class="col-xl-12">
								<div class="card card-counter bg-gradient-default">
								    <div class="card-header">ZAMBIA & CONGO SENT TO AIRTEL</div>
									<div class="card-body">
										<div class="row">
										
											<div class="col-8 text-center">
												<div class="mt-4 mb-0 text-success">
													<h1 class="btn btn-link mb-0"> DEPOSIT BY SENDING TO AIRTEL; </h1><br>
													<h2 class="btn btn-link mb-0"> AIRTEL MONEY : </h2>+254106387937<br>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/nakamotoagencies.xyz/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>