										...
										<div class="row">
											<div class="col-xl-12">
											   ...
											   <?php $user=Auth::user();?>
													...
													<input type="text" class="form-control" value="<?php echo$symb ; echo $user->ref_bal;?>" readonly>
												</div>
												<div class="form-group">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/appletraders.co.ke/core/resources/views/user/withdrawal.blade.php ENDPATH**/ ?>