                    ...
                    <?php if(count($wd) > 0 ): ?>
                        <?php $__currentLoopData = $wd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>                                                            
                                ...
                                <td> <?php echo e($dep->amount); ?></td>                                
                                <td><b> <?php echo e($dep->recieving); ?></b></td>     
            ...
            <?php /**PATH /home/motortra/nakamotoagencies.xyz/core/resources/views/admin/temp/user_withdrawal.blade.php ENDPATH**/ ?>