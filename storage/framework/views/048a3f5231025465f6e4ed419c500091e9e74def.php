										...
										<div class="row">
											...
											<div class="col-8 text-center">
												<div class="mt-4 mb-0 text-success">
													<h1 class="btn btn-link mb-0"> <a href="/<?php echo e(env('DEP_LINK')); ?>" >CLICK TO START STKPUSH</a></h1><br>
													<p class="text-danger mt-1">Ensure you have a good internet and use registered number</p>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											...
											<div class="col-8 text-center">
												<div class="mt-4 mb-0 text-success">
													...
													<h2 class="btn btn-link mb-0"> <a href="/<?php echo e(env('DEP_LINK')); ?>" >MPESA NUMBER : +254112414043 </a></h2><br>
  ...
  <!--=================================================-->
                  ...
                  <p class="text-center">
                      ...
                      <button class="btn btn-primary -center" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                       KENYA MANUAL DEPOSIT
                      </button>
                    </p>
                    <div class="collapse" id="collapseExample">
                      <div class="card card-body">
                          <br>
                        Make your Deposit Directly To  Till: 
                        
                        <!--//copy-->
                        <input type="text" class="form-input" value="9219963" id="myInput"><br>
                            <button class="btn btn-link bg-info"  onclick="myFunction()" > Copy_Till</button>
                        ...
                        <!--//end-->
                        <br>
                        <code>send screenshot to admin</code>
                      </div>
                    </div>
                 ...
                 <p class="text-center">
                      ...
                      <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        UGANDA & Tanzania CLICK HERE
                      </button>
                    </p>
                    <div class="collapse" id="collapseExample">
                      <div class="card card-body">
                          <br>
                        Make your Deposit Directly To  MPESA SAFARICOM: 
                        
                        <!--//copy-->
                        <input type="text" class="form-input" value="+254745687936" id="myInput"><br>
                            <button class="btn btn-link bg-info"  onclick="myFunction()" > Copy_number</button>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/appletraders.co.ke/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>