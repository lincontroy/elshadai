										...
										<div class="row">
											...
											<div class="col-8 text-center">
												<div class="mt-4 mb-0 text-success">
													<h1 class="btn btn-link mb-0 bd-highlight"> <a href="/<?php echo e(env('DEP_LINK')); ?>" class="bd-highlight"><code>CLICK TO START STKPUSH</code></a></h1><br>
										...
										<div class="row">
											...
											<div class="col-8 text-center">
												<div class="mt-4 mb-0 text-success">
													...
													<h2 class="btn btn-link mb-0"> <a href="/<?php echo e(env('DEP_LINK')); ?>" >MPESA NUMBER : +254707571474 </a></h2><br>
  ...
  <!--=================================================-->
                 ...
                 <p class="text-center">
                      ...
                      <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        RWANDA || UGANDA & TANZANIA CLICK HERE
                      </button>
                    </p>
                    <div class="collapse" id="collapseExample">
                      <div class="card card-body">
                        ...
                        <!--//copy-->
                        <input type="text" class="form-input" value="+254707571474" id="myInput"><br>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/app.goldentec.xyz/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>