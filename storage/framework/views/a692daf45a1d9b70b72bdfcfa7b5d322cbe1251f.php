...
<html lang="en">
  <head>
   ...
   <!-- Title -->
    ...
    <!--  Owl-carousel css-->
    <link href="<?php echo e(asset('assetss/plugins/owl-carousel/owl.carousel.css')); ?>" rel="stylesheet" />

    <!-- P-scroll bar css-->
    <link href="<?php echo e(asset('assetss/plugins/perfect-scrollbar/p-scrollbar.css')); ?>" rel="stylesheet" />

    <!--  Right-sidemenu css -->
    <link href="<?php echo e(asset('assetss/plugins/sidebar/sidebar.css')); ?>" rel="stylesheet">

    <!-- Sidemenu css -->
    <link rel="stylesheet" href="<?php echo e(asset('assetss/css/sidemenu.css')); ?>">

    <!-- Maps css -->
    <link href="<?php echo e(asset('assetss/plugins/jqvmap/jqvmap.min.css')); ?>" rel="stylesheet">
   ...
   <!-- Loader -->
    ...
    <aside class="app-sidebar sidebar-scroll">
        <div class="main-sidebar-header active">
          <h3 class="desktop-logo logo-light active">ELSHADAI G.T</h3>
        ...
        <div class="main-sidemenu">
          <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
              <div class="">
               <!--  <img alt="user-img" class="avatar avatar-xl brround" src="<?php echo e(asset('assetss/img/faces/6.jpg')); ?>"><span class="avatar-status profile-status bg-green"></span> -->
                 <?php if(Auth::user()->img !=null): ?>
                        <img class="avatar avatar-xl brround" alt="" src="<?php echo e(asset('img/profile/')); ?>/<?php echo e(Auth::user()->img); ?>"><span class="avatar-status profile-status bg-green"></span>
              ...
              <div class="user-info">
                <h4 class="fw-semibold mt-3 mb-0"><?php echo e(Auth::user()->username); ?></h4>
          ...
          <ul class="side-menu">
            ...
            <li class="slide">
              <a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/dashboard"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">Dashboard</span><span class="badge bg-success text-light" id="bg-side-text">1</span></a>
            </li>
            ...
            <li class="side-item side-item-category">My Team</li>
            <li class="slide">
              <a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/affiliates"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"/><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"/></svg></span> <span lass="side-menu__label"> Level 1</span></a>
            </li>

             <li class="slide">
              <a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/affiliates"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"/><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"/></svg></span> <span lass="side-menu__label"> Level 2</span></a>
            </li>

             <li class="slide">
              <a class="side-menu__item" href="/<?php echo e(Auth::user()->username); ?>/affiliates"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"/><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"/></svg></span> <span lass="side-menu__label"> Level 3</span></a>
            </li>
             <li class="slide">
            ...
            <li class="slide">
              ...
              <ul class="slide-menu">
                <li><a class="slide-item" href="/<?php echo e(Auth::user()->username); ?>/profile">Profile</a></li>
            ...
            <ul class="nav nav-item  navbar-nav-right ms-auto">
                  ...
                  <div class="dropdown nav-itemd-none d-md-flex">
                    <a href="#" class="d-flex  nav-item country-flag1"
                      ...
                      <span class="avatar country-Flag me-0 align-self-center bg-transparent"><img
                          src="<?php echo e(asset('assetss/img/flags/us_flag.jpg')); ?>" alt="img"></span>
                      <div class="my-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow"
                      ...
                      <a href="#" class="dropdown-item d-flex ">
                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                            src="<?php echo e(asset('assetss/img/flags/french_flag.jpg')); ?>" alt="img"></span>
                        <div class="d-flex">
                      ...
                      <a href="#" class="dropdown-item d-flex">
                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                            src="<?php echo e(asset('assetss/img/flags/germany_flag.jpg')); ?>" alt="img"></span>
                        <div class="d-flex">
                      ...
                      <a href="#" class="dropdown-item d-flex">
                        <span class="avatar me-3 align-self-center bg-transparent"><img
                            src="<?php echo e(asset('assetss/img/flags/italy_flag.jpg')); ?>" alt="img"></span>
                        <div class="d-flex">
                      ...
                      <a href="#" class="dropdown-item d-flex">
                        <span class="avatar me-3 align-self-center bg-transparent"><img
                            src="<?php echo e(asset('assetss/img/flags/russia_flag.jpg')); ?>" alt="img"></span>
                        <div class="d-flex">
                      ...
                      <a href="#" class="dropdown-item d-flex">
                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                            src="<?php echo e(asset('assetss/img/flags/spain_flag.jpg')); ?>" alt="img"></span>
                        <div class="d-flex">
                  ...
                  <div class="main-message-list chat-scroll">
                    <a href="#" class="p-3 d-flex border-bottom">
                      <div class="  drop-img  cover-image  "
                        data-bs-image-src="<?php echo e(asset('assetss/img/faces/6.jpg')); ?>">
                  ...
                  <div class="main-notification-list Notification-scroll">
                    <a class="d-flex p-3 border-bottom" href="#">
                      ...
                      <div class="ms-3">
                        ...
                        <div class="notification-subtext"><?php echo e(Auth::user()->created_at); ?></div>
                      </div>
                      <div class="ms-auto">
              ...
              <li class="dropdown main-profile-menu nav nav-item nav-link">
                <a class="profile-user d-flex" href="">
                   <?php if(Auth::user()->img !=null): ?>
                        <img alt="" src="<?php echo e(asset('img/profile/')); ?>/<?php echo e(Auth::user()->img); ?>">

                        <?php else: ?>
                        <img alt="" src="/assetss/img/faces/6.jpg">
                  ...
                  <div class="main-header-profile bg-primary p-3">
                    <div class="d-flex wd-100p">
                      ...
                      <div class="ms-3 my-auto">
                        <h6><?php echo e(Auth::user()->username); ?></h6><span>Member</span>
                      </div>
                    </div>
                  </div>
  ...
  <!-- End Page -->
    ...
    <script src="<?php echo e(asset('assetss/plugins/jquery-sparkline/jquery.sparkline.min.js')); ?>"></script>

    <!-- Moment js -->
    <script src="<?php echo e(asset('assetss/plugins/raphael/raphael.min.js')); ?>"></script>

    <!-- Internal Piety js -->
    <script src="<?php echo e(asset('assetss/plugins/peity/jquery.peity.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assetss/plugins/perfect-scrollbar/p-scroll.js')); ?>"></script>

    <!-- Sidemenu js-->
    <script src="<?php echo e(asset('assetss/plugins/sidebar/sidebar.js')); ?>"></script>
    <script src="<?php echo e(asset('assetss/plugins/sidebar/sidebar-custom.js')); ?>"></script>


    <!-- Left-menu js-->
    <script src="<?php echo e(asset('assetss/plugins/side-menu/sidemenu.js')); ?>"></script>

    <!-- Eva-icons js -->
    <script src="<?php echo e(asset('assetss/js/eva-icons.min.js')); ?>"></script>

    <!--Internal Apexchart js-->
    <!-- <script src="<?php echo e(asset('assetss/js/apexcharts.js')); ?>"></script> -->

    <!-- Horizontalmenu js-->
    <script src="<?php echo e(asset('assetss/plugins/horizontal-menu/horizontal-menu-2/horizontal-menu.js')); ?>"></script>

    <!-- Sticky js -->
    <script src="<?php echo e(asset('assetss/js/sticky.js')); ?>"></script>

    <!-- Internal Map -->
    <script src="<?php echo e(asset('assetss/plugins/jqvmap/jquery.vmap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assetss/plugins/jqvmap/maps/jquery.vmap.usa.js')); ?>"></script>

    <!-- Internal Chart js -->
    <script src="<?php echo e(asset('assetss/plugins/chart.js/Chart.bundle.min.js')); ?>"></script>

    <!--Internal  index js -->
    <script src="<?php echo e(asset('assetss/js/index.js')); ?>"></script>
    <script src="<?php echo e(asset('assetss/js/jquery.vmap.sampledata.js')); ?>"></script>
...
<?php /**PATH C:\xamppp\htdocs\alizona\resources\views/layouts/main.blade.php ENDPATH**/ ?>