        ...
        <div class="">
            <div class="row login_row_cont">
                ...
                <div class="col-md-6 bg_white">
                    ...
                    <div class="col-auto" style="height: 100px; width:100%; background-color: rgba(255,0,0,0.1);">
                        <div class="row">
                            <div class="col-md-12" >
                                <div>                        
                                    <div class="">
...
<br><br><br><br><br><br><hr>
                                       ...
                                       <h1>REGISTER BY FILLING FORM BELOW</h1>
                                               </div>
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/futuregain.xyz/core/resources/views/auth/register.blade.php ENDPATH**/ ?>