					...
					<div class="d-flex my-xl-auto right-content">
						...
						<div class="mb-xl-0">
							<div class="btn-group dropdown">
								<button type="button" class="btn btn-primary"><?php echo e(Auth::user()->created_at); ?></button>
								...
								<div class="ps-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											...
											<img alt="" src="<?php echo e(asset('img/profile/')); ?>/<?php echo e(Auth::user()->img); ?>"><a
										...
										<div class="d-flex justify-content-between mg-b-20">
											<div>
												<h5 class="main-profile-name"><?php echo e(Auth::user()->username); ?></h5>
												<p class="main-profile-name-text">Member</p>
											</div>
										</div>
										<h6>Bio</h6>
										<div class="main-profile-bio">
											<?php echo e(Auth::user()->bio); ?> <a href="">More</a>
										...
										<div class="main-profile-social-list">
											...
											<div class="media">
												...
												<div class="media-body">
													<span>Twitter</span> <a href="">twitter.com/<?php echo e(Auth::user()->tweeter); ?></a>
												</div>
											</div>
											<div class="media">
												...
												<div class="media-body">
													<span>Facebook</span> <a href="">facebook.com/<?php echo e(Auth::user()->fb); ?></a>
												</div>
											</div>
											<div class="media">
									...
									<div class="card-body">
										<div class="counter-status d-flex md-mb-0">
											...
											<div class="ms-auto">
												...
												<h2 class="mb-0 tx-22 mb-1 mt-1"><?php echo e(Auth::user()->currency); ?> <?php echo e(Auth::user()->wallet); ?></h2>
									...
									<div class="card-body">
										<div class="counter-status d-flex md-mb-0">
											...
											<div class="ms-auto">
												...
												<h2 class="mb-0 tx-22 mb-1 mt-1"><?php echo e(Auth::user()->currency); ?> <?php echo e(Auth::user()->ref_bal); ?></h2>
												<p class="text-muted mb-0 tx-11"><i
														class="si si-arrow-up-circle text-success me-1"></i>increase</p>
											</div>
										</div>
							...
							<div class="card-body">
								...
								<div class="tab-content border-start border-bottom border-right border-top-0 p-4 br-dark">
									<div class="tab-pane active" id="home">
										...
										<p class="m-b-5"><?php echo e(Auth::user()->bio); ?></p>
									...
									<div class="tab-pane" id="settings">
										<form role="form" action="<?php echo e(url('profile/update')); ?>" method="post" enctype="multipart/form-data">
											<?php echo csrf_field(); ?>
											<div class="form-group">
												<label for="FullName">Full Name</label>
												<input type="text" id="FullName" class="form-control" value="<?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?>" readonly>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="text" value="<?php echo e(Auth::user()->username); ?>" id="Username" class="form-control" readonly>
											</div>

											<div class="form-group">
												<label for="Username">Profile</label>
												<input type="file" value="<?php echo e(Auth::user()->img); ?>" name="user_photo" id="Username" class="form-control">
											</div>
											
											<div class="form-group">
												<label for="AboutMe">About Me</label>
												<textarea id="AboutMe"
													class="form-control" name="bio"><?php echo e(Auth::user()->bio); ?></textarea>
											</div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\alizona\resources\views/user/profile.blade.php ENDPATH**/ ?>