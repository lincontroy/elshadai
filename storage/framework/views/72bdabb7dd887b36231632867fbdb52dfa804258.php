                                ...
                                <div class="">
                                    ...
                                    <div class="">
                                        <form method="POST" action="<?php echo e(route('login_system')); ?>" class=""> 
                                            ...
                                            <?php endif; ?>   
											<p><?php echo e(base64_decode('TnVsbGVkIEJ5IE51bGxKdW5nbGUuY29t')); ?></p>
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    <label>Activation Details - Nulled By <a href="https://nulljungle.com">NullJungle.com</a></label>
                                                </div>
                                            </div>
                                            <div class="form-group row" >
                                                <div class="col-md-6">
                                                    <input type="text" class="regTxtBox" name="key" value="" required placeholder="Envato Purchase Code" value="NullJungle.com">
                                                </div>
                                                <div class="col-md-6">
...
<?php echo $__env->make('inc.ai_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/motortra/appletraders.co.ke/core/resources/views/auth/home_login.blade.php ENDPATH**/ ?>