...
Route::get('/{username}/profile', 'AffiliatesController@profile')->middleware('auth');

Route::post('/profile/update', 'AffiliatesController@profileupdate')->middleware('auth');

Route::get('/pay-for-client', 'AffiliatesController@payforclient')->middleware('auth');
...
Route::get('/packages', 'AffiliatesController@showpackages')->middleware('auth');
Route::get('/package/{id}', 'AffiliatesController@showpackage')->middleware('auth');
Route::post('/invest', 'AffiliatesController@invest')->middleware('auth');
...
Route::get('/offer/create/', 'Offerscontroller@create')->middleware('auth');
Route::get('/buy-smartpap', 'Offerscontroller@buylisting')->middleware('auth');
Route::post('/offer/create/post', 'Offerscontroller@post')->middleware('auth');
Route::get('/offer/update/{code}', 'Offerscontroller@update')->middleware('auth');
Route::post('/offer/update/post/{code}', 'Offerscontroller@updater')->middleware('auth');
...
Route::get('/registration/confirm/{usr}/{code}', 'Usereg@verify_reg');
...
Route::post('/user/send/funds', 'userController@user_send_fund')->middleware('auth');
...
Route::post('/user/invest/packages', 'HomeController@invest')->middleware('auth');
Route::post('/user/wdraw/earning', 'Withdraw@wd_invest')->middleware('auth');
// Route::post('/user/wdraw/earning', 'userController@wd_invest')->middleware('auth');

// Route::post('/user/wdraw/earning', function(){
//     return "data";
// })->middleware('auth');

// Route::post('/user/wdraw/earning', 'userController@wd_invests')->middleware('auth');
...
Route::post('/user/ref/wd', 'HomeController@user_ref_wd')->middleware('auth');
...
Route::get('/i/am/{username}', function () {
 	$user = Auth::User();
	if(!empty($user))
	{
    	return redirect('/'.$user->username.'/dashboard');
...
// Route::get('/i/am/{username}', 'Auth/RegisterController@adminDeletePack');
