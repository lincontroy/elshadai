                    ...
                    @foreach($invs as $inv)
							...
							<div class="col-sm-6 col-lg-6 col-xl-3">
								<div class="card card-pricing shadow text-center px-3 ">
									<span class="h6 w-60 mx-auto px-4 py-1 rounded-bottom bg-primary text-white ">{{$inv->package_name}}</span>
									<div class="bg-transparent border-0">
										<h1 class="h1 font-weight-normal text-primary text-center mb-0" data-pricing-value="30"><span class="price"> {{$inv->period}}</span><span class="h6 text-muted ml-2">/ days</span></h1>
									</div>
									<div class="card-body pt-0">
										...
										<a id="{{$inv->id}}" href="javascript:void(0)"  class="btn btn-primary mb-3" onclick="confirm_inv('{{$inv->id}}', '{{$inv->package_name}}', '{{$inv->period}}', '{{$inv->daily_interest}}', '{{$inv->min}}', '{{$inv->max}}', '{{$user->wallet}}')">Order Now</a>
									</div>
								</div>
							</div><!-- col-end -->
