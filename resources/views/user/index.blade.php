      ...
      <!-- /main-header -->
        ...
        <div class="breadcrumb-header justify-content-between">
          <div class="left-content">
            <div>
              <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Hi, welcome back! {{Auth::user()->username}}</h2>
              ...
              <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="ps-3 pt-3 pe-3 pb-2 pt-0">
                  ...
                  <div class="pb-0 mt-0">
                    <div class="d-flex">
                      <div class="">
                        <h4 class="tx-20 fw-bold mb-1 text-white">{{Auth::user()->currency}} 0</h4>
                        <p class="mb-0 tx-12 text-white op-7">Compared to last week</p>
                      </div>
                      <span class="float-end my-auto ms-auto">
                  ...
                  <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                   ...
                   <tbody>
                      <tr>
                        ...
                        <td class="tx-left tx-medium tx-inverse"><a href="{{url('/i/am/')}}/{{Auth::user()->username}}" >{{url('/i/am/')}}/{{Auth::user()->username}}</a></td>

                        <td class="tx-right tx-medium tx-inverse"><a href="{{url('/i/am/')}}/{{Auth::user()->username}}" class="btn btn-info" onclick="copyURI(event)">Copy</a></td>
